...
export default function HomeScreen() {
  ...
  useEffect(() => {
    ...
    //cihaz arama olaylarını dinleme

    const handleDiscover = (peripheral) => {

      console.log('--- Cihaz bulundu ---', peripheral.id);
  ...
  const startScan = async () => {
    ...
    BleManager.enableBluetooth()
      ...
      .then(() => {
        ...
        // 3. Parametre: Tekrar eden cihazlara izin verilsin mi
